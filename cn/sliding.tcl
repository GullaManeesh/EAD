# Sliding Window Protocol in NS2
...
# Create TCP agent at sender
set tcp [new Agent/TCP]
$tcp set class_ 1
$ns attach-agent $sender $tcp

# Create TCP Sink at receiver
set sink [new Agent/TCPSink]
$ns attach-agent $receiver $sink
$ns connect $tcp $sink

# Set TCP parameters for Sliding Window
$tcp set window_ 4         ;# Window size = 4 packets
$tcp set packetSize_ 512   ;# Packet size

# Create FTP application to generate data
